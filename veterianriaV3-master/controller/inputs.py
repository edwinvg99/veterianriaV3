...
def validarfactura_sin_orden(id_factura,cedula_cliente, producto, valor, cantidad_llevar):
   ...
   if not all([id_factura, cedula_cliente, producto, valor, cantidad_llevar]):
       ...
       valor= int(valor)
       cantidad_llevar= int(cantidad_llevar)
       business.factura_sin_orden(id_factura,cedula_cliente, producto, valor, cantidad_llevar)
